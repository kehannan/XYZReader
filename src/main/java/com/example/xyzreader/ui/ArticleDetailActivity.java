...
//        }
        ...
        // Instatiated ViewPager
        mPager = (ViewPager) findViewById(R.id.pager);

        // Instantiate FragmentStatePagerAdapter
...
//        }
        ...
        if (savedInstanceState == null) {
            if (getIntent() != null && getIntent().getData() != null) {
                Log.v(TAG, "in savedInstanceState Check " + getIntent().getData().toString());
                mStartId = ItemsContract.Items.getItemId(getIntent().getData());
                Log.v(TAG, "mStartId " + mStartId);
...
//        Log.v(TAG, "onLoadFinished(). mStartId " + mStartId);
        ...
        if (mStartId > 0) {
            ...
            while (!mCursor.isAfterLast()) {
                ...
                Log.v(TAG, "Article ID " + mCursor.getLong(ArticleLoader.Query._ID));
